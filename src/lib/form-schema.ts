...
export const jobFormSchema = z.object({
  ...
  jobType: z.enum(JOBTYPES, {
    required_error: "You need to select a job types",
  }),
  ...
  jobDescription: z
    .string({ required_error: "Job Description From is required" })
    .min(10, { message: "Job Description must be at least 10 characters" }),
  responsibility: z
    .string({ required_error: "Responsibility Form is required" })
    .min(10, { message: "Responsibility must be at least 10 characters" }),
  whoYouAre: z
    .string({ required_error: "Who You Are Form is required" })
    .min(10, { message: "Who You Are must be at least 10 characters" }),
  niceToHaves: z
    .string({ required_error: "Nice To Have Form is required" })
