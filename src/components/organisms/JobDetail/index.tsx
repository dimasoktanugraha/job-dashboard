    ...
    <div>
      <div className="grid grid-cols-3 w-full gap-5">
        <div className="col-span-2 space-y-10">
          ...
          <div>
            <div className="text-3xl font-semibold">Responsibilties</div>
            <div
              className="text-gray-500 mt-3"
          ...
          <div>
            <div className="text-3xl font-semibold">Nice-To-H aves</div>
            <div
              className="text-gray-500 mt-3"
        ...
        <div>
          ...
          <div className="my-10">
            <div className="text-3xl font-semibold mb-4">Recommendations</div>
      ...
      <div>
        <div className="text-3xl font-semibold">Perks & Benfits</div>
        <div className="text-gray-500">
          This job comes with several perks and benefits
        </div>
        <div className="grid grid-cols-4 gap-5 mt-9">
          {benefits?.map((item: any) => (
            <div key={item} className="border border-gray-100 rounded-sm p-3">
