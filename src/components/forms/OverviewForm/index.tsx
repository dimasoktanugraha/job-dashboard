...
const OverviewForm: FC<OverviewFormProps> = ({ detail }) =>  {
    ...
    const { data, error, isLoading } = useSWR<Industry[]>('/api/company/industries', fetcher)
    ...
    return (
        <div>
            <div className='my-5'>
                <TitleForm title='Basic Information' subtitle='This company information that you can update anytime'/>
            </div>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                    ...
                    <FieldInput
                        title='About Company'
                        subtitle='Brief description for your company. URLs is hyperlink'
                    >
